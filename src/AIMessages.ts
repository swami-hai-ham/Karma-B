    ...
    messages: [
      {
        ...
        content: [
          {
            type: "text",
            text: `Character: ${Character}, Todo: ${JSON.stringify(
              Todo
